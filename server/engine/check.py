...
# ---------------- 库化别名（M1.2） ----------------
# Web 层 / 测试用统一入口名；CLI 行为不变。
skill_check = check_skill    # 技能检定：skill_check(skill_name, skill_value, by, why, ...)
luck_check = check_luck      # 幸运检定：luck_check(current_luck, by, why, ...)
